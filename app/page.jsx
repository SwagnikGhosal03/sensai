    ...
    <div>
      ...
      <section className="w-full py-12 md:py-24 lg:py-32 bg-background">
        <div className="container mx-auto px-4 md:px-6">
          <h2 className="text-3xl tracking-tighter font-bold mb-12 text-center">Powerful Features for Your Career Growth</h2>
      ...
      <section className="w-full py-12 md:py-24  bg-background">
        <div className="container mx-auto px-4 md:px-6">
          <h2 className="text-3xl tracking-tighter font-bold mb-12 text-center">What Our Users Say</h2>
            ...
            return (
              ...
              <div className="flex flex-col space-y-4">
                <div className="flex items-center space-x-4 mb-4">
                  <div className="relative h-12 w-12 flex-shrink">
      ...
      <section className="w-full">
        <div className="mx-auto py-24 gradient rounded-lg">
          <div className="flex flex-col items-center justify-center space-y-4 text-center max-w-3xl mx-auto">
           <h2 className="text-3xl tracking-tight font-bold text-primary-foreground md:text-5xl sm:text-4xl">Ready to Accelerate Your Career?</h2>
           <p className="text-primary-foreground/80 md:text-xl mx-auto max-w-[600px]">Join thousands of professionals who are advancing their careers
